          ...
          >
            ...
            >
              <Tooltip title="LinkedIn">
                <a
                  href="https://www.linkedin.com/in/gowtham-r-88205723a"
                  target="_blank"
                  rel="noreferrer"
                >
                  <LinkedinOutlined
              ...
              <Tooltip title="GitHub">
                <a
                  href="https://github.com/gowtham140"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <Tooltip title="Instagram">
                <a
                  href="https://www.instagram.com/_.gowtham._14_?igsh=OXJodHg3cDlybmth"
                  target="_blank"
                  rel="noreferrer"
                >
                  <InstagramOutlined
        ...
        <div style={{ padding: 16 }}>
          <Space size="middle">
            <a
              ...
              rel="noreferrer"
            >
              <LinkedinOutlined style={{ fontSize: 22, color: "#1890ff" }} />
            </a>
            <a
              href="https://github.com/gowtham"
              target="_blank"
              rel="noreferrer"
            >
